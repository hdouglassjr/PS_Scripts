...
Get-DbaUserPermission -SqlInstance $sql -SqlCredential $testSqlUser -Database AdventureWorks | Where-Object { $_.Member -eq "ESPEED4\TestSqlUser1" } |  Format-Table -AutoSize
